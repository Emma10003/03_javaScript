...
selectBtn.addEventListener("click", function(){
    ...
    */
    ...
    console.log("Math.random(): " + mr);    // 콘솔에서 어떻게 보이는지 로그기록을 보기 위함
    console.log("randomNumber: " + randomNumber);
    console.log("randomNumber[randomNumber]: " + menus[randomNumber]);
    menuResult.innerText = menus[randomNumber];   // 해당 인덱스의 값을 menuResult 안에 텍스트로 넣겠다
});