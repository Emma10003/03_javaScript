...
// 1. select all 이용해서 number id 모두 배열로 가져오기
// 2. id값을 result로 가져오기
...
for (let i = 0; i < numbers.length; i++) {
  /*
        ...
        numbers[i].addEventListener("click", () => {  
            ...
            // 이 내부에는 function이 없기 대문에 this 사용할 수 없음!!!
        ...
        numbers[i].addEventListener("click", e => { 
            ...
            // 마찬가지로 function이 없기 때문에 this 사용 불가
  ...
  numbers[i].addEventListener("click", function () {
    ...
    result.textContent += this.textContent; // 입력창이 result.textContent
  });
}
